  ...
  <div class="row" style="padding:1vw;">
    <div class="col-xl-12"> <i><u><strong>ADDRESS OF SERVICE</strong></u></i><br>
      <div class="col-xs-12 col-form-label">
        ...
        <input type="text" readonly class="form-control-plaintext" id="ADD1" style="color: white" value='<?php echo $Adrs ?>'>
      </div>
      <div class="form-group col-md-6 mb-0">
        <label for="LName" class="col-xl-6 col-form-label" style="color:#FFF700;">Pincode:</label>
        <input type="text" readonly class="form-control-plaintext" id="LName" style="color: white" value=<?php echo $Pcode ?> >
      </div>
    </div>
   </div>
...
function test_input($data) {
  ...
  if (empty($_POST["PC"])) {
    ...
    {
    $Pinc=test_input($_POST["PC"]);
    if (strlen($Pinc)!=6){
     $PCErr = "Invalid Pincode"; 
    }
    else{
      $order2 = "UPDATE user SET Address = '$Addr' WHERE Email='$EMAILS'";
      $order3 = "UPDATE user SET Pincode = '$Pinc' WHERE Email='$EMAILS'";
      $result2 = mysqli_query($conn,$order2);
      $result3 = mysqli_query($conn,$order3);
      $mess1="Address Updated!, view updated address!";
    }
  }
}
?>
   <button type="button" class="btn btn-dark btn-lg" data-toggle="modal" data-target="#myModal"> Change Service Address </button>
   <br><a href=""><?php echo $mess1; ?></a>
        ...
        <div class="modal-body">
          <div class="form-group">
            <form class="form-container" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
              ...
              <input type="text" placeholder="Full Address" style="color: black;" name="live1" required><br><?php echo $AddrErr;?><br>

               <label for="PC"><b>Pincode:</b></label>
               <input type="text" style="color: black;" name="PC" maxlength="6" required><br><?php echo $PCErr;?>
            </div>
             <br>
