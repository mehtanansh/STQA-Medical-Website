...
if ($_SESSION['loggedin']==true){
  header("Location: http://localhost/PHP%20College%20Medical%20website/Clg Project/");
}
?>
<!DOCTYPE html>
<html>
    ...
    if(!$uppercase or !$lowercase or !$number or !$specialChars or !$lengths){
      ...
      else
      {
        ...
        if ($passwords1==$row['Password']){
          ...
          $_SESSION['Mail'] = $Emails;
          mysqli_close($db);
          header("Location: http://localhost/PHP%20College%20Medical%20website/Clg Project/User/Profile.php");
        }
        else{
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="Sign Up.php">Sign Up as a User</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="">Sign In as a User</a>
        </div>
      </li>
...
<fieldset style="background: rgba(0,0,0,0.5);padding: 2vw;border-radius: 1vw;" class="form-group">
    <strong style="font-size: 22px;"> Sign In </strong>
      ...
      <button type="submit" class="btn btn btn-outline-dark" style="color: #D7FF33;">Sign In</button>
